...
if __name__ == "__main__":
    ...
    #pc_centerline = center_line_registrator.parse_point_cloud_centerline("workflow_data/centerline_phantom.txt", display_results)

    # Make smoother bifurication curves
    # smoothed_pc_centerline = center_line_registrator.smooth_centerline(pc_centerline, display_results)
