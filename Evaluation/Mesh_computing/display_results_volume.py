...
diff_4 = abs(df_gt['Volume']- df_4['Volume'])
diff_5 = abs(df_gt['Volume']- df_5['Volume'])
diff_6 = abs(df_gt['Volume']- df_6['Volume'])
...
if oct_section:
    ...
    gt_volume = df_gt['Volume'][600:850]
    volume_1 = df_2['Volume'][600:850]
    volume_2 = df_3['Volume'][600:850]
    volume_3 = df_4['Volume'][600:850]
    volume_4 = df_5['Volume'][600:850]
    volume_5 = df_6['Volume'][600:850]
else:
    gt_volume = df_gt['Volume']
    volume_1 = df_2['Volume']
    volume_2 = df_3['Volume']
    volume_3 = df_4['Volume']
    volume_4 = df_5['Volume']
    volume_5 = df_6['Volume']
...
# Assuming the columns for volume measurements are named 'Volume'
if oct_section:
    gt_volume = df_gt['Volume'][200:350]#[600:850]
    volume_1 = df_2['Volume'][200:350]#[600:850]
    volume_2 = df_3['Volume'][200:350]#[600:850]
    volume_3 = df_4['Volume'][200:350]#[600:850]
    volume_4 = df_5['Volume'][200:350]#[600:850]
    volume_5 = df_6['Volume'][200:350]#[600:850]
else:
    gt_volume = df_gt['Volume']
    volume_1 = df_2['Volume']
    volume_2 = df_3['Volume']
